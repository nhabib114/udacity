...
with open(train_datasets[4], "rb") as f:
     data = pickle.load(f)
plt.imshow(data[3000], cmap='Greys')
...
plt.imshow(test_dataset[50], cmap='Greys')
...
logreg.fit(d2_train_dataset[0:5000], train_labels[0:5000])
...
pred = logreg.predict(d2_test_dataset[0:5000])
accuracy_score(pred, test_labels[0:5000])
